    ...
    if (data.success) {
      return `
        <div class="glass-card max-w-md mx-auto bg-gray-800 p-6 rounded-lg">
          ...
          <button onclick="navigate('/login?message=email_verified')" class="glass-button w-full bg-blue-500 p- hjeml rounded">
            Go to Login
          </button>
        </div>
      `;
      ...
      return `
        <div class="glass-card max-w-md mx-auto bg-gray-800 p-6 rounded-lg">
          ...
          <div class="space-y-2">
            <button onclick="navigate('/login')" class="glass-button w-full bg-blue-500 p-2 rounded">
              Go to Login
            </button>
            <button onclick="navigate('/register')" class="glass-button w-full bg-green-500 p-2 rounded">
              Create New Account
            </button>
          </div>
        </div>
